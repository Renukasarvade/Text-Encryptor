package text_Encryptor;

/** 
 * @author root
 * 
 * Project: Text Encryptor (GUI Desktop Application)
 * 
 * Pre-requisite: 1. Basic Java 
 * 				  2. Java Swing/ 
 * 				  3. Java AWT
 * 			      
 *
...
public class Text_Encryptor extends javax.swing.JFrame  {
	/**
     * Creates new form Text_Encryptor
     */
    public Text_Encryptor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Exit.setFont(new java.awt.Font("Segoe UI Semibold", 1, 18)); // NOI18N
        Exit.setText("Exit");
    ...
    private void EncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EncryptActionPerformed
        ...
        String encryptedtext = shiftText(plaintext, shiftAmount);
    ...
    */
    ...
    private void ClearAllFiealds(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EncryptActionPerformed
    ...
    private String shiftText(String pt, int s){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Text_Encryptor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Text_Encryptor().setVisible(true);
            }
        });
    }
